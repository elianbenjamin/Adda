...
export function MapMarkerIcon(props: SVGProps<SVGSVGElement>) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" {...props}>
      <path
        fill="currentColor"
...
export function ArrowDownCircle(props: SVGProps<SVGSVGElement>) {
  return (
    <svg
