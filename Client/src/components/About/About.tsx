        ...
        <section className={style.section1}>
          ...
          <div className={style.textContainer}>
            <p>
              ...
              Laboriosam architecto rerum possimus voluptates vel impedit, sequi
              debitis velit dolores unde ipsum error quam modi commodi? Soluta
              minus eveniet sed numquam. Lorem ipsum dolor sit amet consectetur
